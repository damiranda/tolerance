...
apod_data$Libros_apod_rec <- ifelse((apod_data$Libros_apod==1), 1,
                                ifelse((apod_data$Libros_apod==2), 1,
                                       ifelse((apod_data$Libros_apod==3), 2,
                                              ifelse((apod_data$Libros_apod==4), 2,
                                                     ifelse((apod_data$Libros_apod==5), 3,
                                                            ifelse((apod_data$Libros_apod==6), 3, NA))))))
...
apod_data$Libros_apod_rec <- set_labels(x = apod_data$Libros_apod_rec, labels = c("Entre 0 y 25 libros" = 1, "Entre 26 y 200 libros" = 2, "Más de 200 libros" = 3))
