...
apod_data$ingresos_tramos <- set_label(x = apod_data$ingresos_tramos,label = "Ingresos del hogar")
```
...
# ingresos per capita
summary(apod_data$ingresos_pc)
# ingresos tramos factor
frq(apod_data$ingresos_tramos_factor)
