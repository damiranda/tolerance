...
# Ingresos del hogar divididos en tramos

```{r}
# Ingresos tramos
data$Ingresos[data$Ingresos == 12 | data$Ingresos == 13] <- 99
# Etiquetar
data$Ingresos <-set_label(x=data$Ingresos,label = c("Menos de $101.000 mensuales líquidos" = 1,
                                                    ...
                                                    "Ns/Nr"=99))
# Drop levels
data$Ingresos <- set_na(data$Ingresos, na = c(99), drop.levels = TRUE, as.tag = FALSE)
```
