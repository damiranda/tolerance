...
apod_cfa = apod_data %>% 
  dplyr::select(Igualdad1,Igualdad2,Igualdad3,Igualdad4,Igualdad5,Igualdad6,Igualdad7,Igualdad8,Igualdad9,FOLIO,FOLIO_EST) %>% 
  as.data.frame()
```
...
### Valores perdido y base reducida para AFC
```{r}
