...
pacman::p_load(stargazer, ggplot2, sjmisc, car, sjlabelled, haven, cowplot,
               ...
               psych, lme4, ppcor, texreg, skimr, sessioninfo, dplyr)
...
plotdata <- data_proc %>%
  ...
  summarize(n = n(),
         ...
         se = sd / sqrt(n),
         ci = qt(0.99, df = n - 1) * sd / sqrt(n))
plotdata$Libros_apod_rec <- factor(plotdata$Libros_apod_rec, levels = c(1,2,3), labels = c(
"Entre 0 y 
25 libros",
"Entre 26 y
200 libros", 
...
> Edecto directo desde educacion de los padres en CID : B ( r= basica, media = 0.02, tecnicos = 00.9, universitaria = 0,17)
...
data_proc$Libros_apod_rec <- factor(data_proc$Libros_apod_rec, levels = c(1,2,3), labels = c("Entre 0 y 25 libros", "Entre 26 y 200 libros (Ref. 25 o menos)", "Más de 200 libros"))
data_proc$quintiles_ingresos_pc_factor <- factor(data_proc$quintiles_ingresos_pc_factor, levels = c(1,2,3,4,5,99), labels = c("Quintil 1", "Quintil 2 (Ref. Quintil 1)", "Quintil 3", "Quintil 4", "Quintil 5", "Ns/Nr"))
   ...
   collapse_rows_dt <- data.frame(Variable = c(rep("Educación de los padres", 3), rep("Cantidad de libros", 2), rep("Quintiles de ingreso",5)),
                    ...
                    Efectos_Directos = c(round(reg_igual4E@beta[2:4],3), 
                                         round(reg_igual4L@beta[2:3],3),
                                         round(reg_igual4Q@beta[2:6],3)),
                    Efectos_Indirectos = c(round(reg_igual1E@beta[2:4]*reg_igual4E@beta[5],3),
                                           round(reg_igual1L@beta[-1]*reg_igual4L@beta[4],3),
                                           round(reg_igual1Q@beta[-1]*reg_igual4Q@beta[7],3)),
                    Efectos_Totales =  c(round(reg_igual2E@beta[2:4],3),
                                         round(reg_igual2L@beta[2:3],3),
                                         round(reg_igual2Q@beta[2:6],3)),
                    Porcentaje_Indirecto = c(paste(round(reg_igual1E@beta[2:4]*reg_igual4E@beta[5]*100/reg_igual2E@beta[2:4],1),"%"),
  paste(round(reg_igual1L@beta[-1]*reg_igual4L@beta[4]*100/reg_igual2L@beta[2:3],1),"%"),
  paste(round(reg_igual1Q@beta[-1]*reg_igual4Q@beta[7]*100/reg_igual2Q@beta[2:6],1),"%")),
                    Efectos_Directos = c(round(reg_esp.pub4E@beta[2:4],3),
                                         round(reg_esp.pub4L@beta[2:3],3),
                                         round(reg_esp.pub4Q@beta[2:6],3)),
                    Efectos_Indirectos = c(round(reg_esp.pub1E@beta[2:4]*reg_esp.pub4E@beta[5],3),
                                           round(reg_esp.pub1L@beta[-1]*reg_esp.pub4L@beta[4],3),
                                           round(reg_esp.pub1Q@beta[-1]*reg_esp.pub4Q@beta[7],3)),
                    Efectos_Totales =  c(round(reg_esp.pub2E@beta[2:4],3),
                                         round(reg_esp.pub2L@beta[2:3],3),
                                         round(reg_esp.pub2Q@beta[2:6],3)),
                    Porcentaje_Indirecto = c(paste(round(reg_esp.pub1E@beta[2:4]*reg_esp.pub4E@beta[5]*100/reg_esp.pub2E@beta[2:4],1),"%"),
  paste(round(reg_esp.pub1L@beta[-1]*reg_esp.pub4L@beta[4]*100/ reg_esp.pub2L@beta[2:3],1),"%"),                   paste(round(reg_esp.pub1Q@beta[-1]*reg_esp.pub4Q@beta[7]*100/reg_esp.pub2Q@beta[2:6],1),"%")),
                    Efectos_Directos = c(round(reg_esp.priv4E@beta[2:4],3),
                                         round(reg_esp.priv4L@beta[2:3],3),
                                         round(reg_esp.priv4Q@beta[2:6],3)),
                    Efectos_Indirectos = c(round(reg_esp.priv1E@beta[2:4]*reg_esp.priv4E@beta[5],3),
                                           round(reg_esp.priv1L@beta[-1]*reg_esp.priv4L@beta[4],3),
                                           round(reg_esp.priv1Q@beta[-1]*reg_esp.priv4Q@beta[7],3)),
                    Efectos_Totales = c(round(reg_esp.priv2E@beta[2:4],3),
                                        round(reg_esp.priv2L@beta[2:3],3),
                                        round(reg_esp.priv2Q@beta[2:6],3)),
                    Porcentaje_Indirecto = c(paste(round(reg_esp.priv1E@beta[2:4]*reg_esp.priv4E@beta[5]*100/reg_esp.priv2E@beta[2:4],1),"%"),
  paste(round(reg_esp.priv1L@beta[-1]*reg_esp.priv4L@beta[4]*100/ reg_esp.priv2L@beta[2:3],1),"%"),
  paste(round(reg_esp.priv1Q@beta[-1]*reg_esp.priv4Q@beta[7]*100/reg_esp.priv2Q@beta[2:6],1),"%")))
