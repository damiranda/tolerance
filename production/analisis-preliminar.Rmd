...
load(url("https://raw.githubusercontent.com/damiranda/tolerance/main/input/data-proc/data.rda?token=AQC2NONTJECJJAYB7T3HGSDAIYRJO"))
...
data$Ed.madre.cat <- set_labels(data$Ed.madre.cat, labels=c("1" ="8vo básico o menos", 
                                                            "Educación media" = 2,
...
reg2_igualdad <- lmer(igualdad.est ~ 1 + Ed.madre.cat + Ed.padre.cat + Libros + Ingresos + (1 | RBD), data=data)

reg3_igualdad <- lmer(igualdad.est ~ 1 + igualdad.pad + (1 | RBD), data=data)

reg4_igualdad <- lmer(igualdad.est ~ 1 + Sexo + Ed.madre.cat + Ed.padre.cat + Libros + Ingresos + igualdad.pad + (1 | RBD), data=data)
...
reg3_igualdad.ing <- lmer(igualdad.est ~ 1 + igualdad.pad + esp_publico.pad + esp_privado.pad + (1 | RBD), data=data)
