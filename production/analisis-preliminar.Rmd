 ...
 collapse_rows_dt <- data.frame(Variable = c(rep("Educación de los padres", 3), rep("Cantidad de libros", 2), rep("Quintiles de ingreso",5)),
                    Categorias = c(sjlabelled::get_labels(data_proc$Educacion)[-1],
                     ...
                     Efectos_Directos = c(paste0(round(reg_igual4E@beta[2:4],3),gtools::stars.pval(sreg_igual1E$coefficients[2:4,5])),
                                         paste0(round(reg_igual4L@beta[2:3],3),gtools::stars.pval(sreg_igual4L$coefficients[2:3,5])),
                    ...
                    Efectos_Indirectos = c(
                                           ...
                                           paste0(round(reg_igual1L@beta[-1]*reg_igual4L@beta[4],3),   gtools::stars.pval(iL1_L4[2,1])),
                                           paste0(round(reg_igual1Q@beta[-1]*reg_igual4Q@beta[7],3), gtools::stars.pval(iQ1_Q4[2,1]))
                                           ),
                    Efectos_Totales =  c(
                                         paste0(round(reg_igual2E@beta[2:4],3),gtools::stars.pval(sreg_igual2E$coefficients[2:4,5])),
                                         paste0(round(reg_igual2L@beta[2:3],3),gtools::stars.pval(sreg_igual2L$coefficients[2:3,5])),
                    ...
                    Efectos_Directos = c(
                                         ...
                                         paste0(round(reg_esp.pub4L@beta[2:3],3), gtools::stars.pval(sreg_esp.pub4L$coefficients[2:3,5])),
                    ...
                    Efectos_Indirectos = c(
                                          paste0(round(reg_esp.pub1E@beta[2:4]*reg_esp.pub4E@beta[5],3),gtools::stars.pval(puE1_E4[2,1])),
                                           paste0(round(reg_esp.pub1L@beta[-1]*reg_esp.pub4L@beta[4],3), gtools::stars.pval(puE1_E4[2,1])),
                                           paste0(round(reg_esp.pub1Q@beta[-1]*reg_esp.pub4Q@beta[7],3),gtools::stars.pval(puE1_E4[2,1]))),
                   
                   
                   
                    Efectos_Totales =  c(
                                          paste0(round(reg_esp.pub2E@beta[2:4],3),gtools::stars.pval(sreg_esp.pub2E$coefficients[2:4,5])),
                                         paste0(round(reg_esp.pub2L@beta[2:3],3),gtools::stars.pval(sreg_esp.pub2L$coefficients[2:3,5])),
                    ...
                    Efectos_Directos = c(
                                         ...
                                         paste0(round(reg_esp.priv4L@beta[2:3],3),gtools::stars.pval(sreg_esp.priv4L$coefficients[2:3,5])),
                   ...
                   Efectos_Indirectos = c(paste0(round(reg_esp.priv1E@beta[2:4]*reg_esp.priv4E@beta[5],3), gtools::stars.pval(prE1_E4[2,1])),
                                           paste0(round(reg_esp.priv1L@beta[-1]*reg_esp.priv4L@beta[4],3),gtools::stars.pval(prE1_E4[2,1])),
                                           paste0(round(reg_esp.priv1Q@beta[-1]*reg_esp.priv4Q@beta[7],3),gtools::stars.pval(prE1_E4[2,1]))),
                 
                    Efectos_Totales = c(
                                        paste0(round(reg_esp.priv2E@beta[2:4],3),gtools::stars.pval(sreg_esp.priv2E$coefficients[2:4,5])),
                                        paste0(round(reg_esp.priv2L@beta[2:3],3),gtools::stars.pval(sreg_esp.priv2L$coefficients[2:3,5])),
