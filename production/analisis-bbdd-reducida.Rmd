...
collapse_rows_dt2 <- data.frame(Variable = c(rep("Educación de los padres", 3), rep("Cantidad de libros", 3), rep("Quintiles de ingreso",5)),
                    ...
                    Porcentaje_Indirecto = c(
                                             paste0(round(med_out_iged1[["z0"]]*med_out_iged1[["d0"]]*100/med_out_iged1[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iged2[["z0"]]*med_out_iged2[["d0"]]*100/med_out_iged2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iged3[["z0"]]*med_out_iged3[["d0"]]*100/med_out_iged3[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iglib1[["z0"]]*med_out_iglib1[["d0"]]*100/med_out_iglib1[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iglib2[["z0"]]*med_out_iglib2[["d0"]]*100/med_out_iglib2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iglib3[["z0"]]*med_out_iglib3[["d0"]]*100/med_out_iglib3[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iging1[["z0"]]*med_out_iging1[["d0"]]*100/med_out_iging1[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iging2[["z0"]]*med_out_iging2[["d0"]]*100/med_out_iging2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iging3[["z0"]]*med_out_iging3[["d0"]]*100/med_out_iging3[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iging4[["z0"]]*med_out_iging4[["d0"]]*100/med_out_iging4[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iging5[["z0"]]*med_out_iging5[["d0"]]*100/med_out_iging5[["tau.coef"]],1),"%")
                                             ),
                    ...
                    Porcentaje_Indirecto = c(
                                             paste0(round(med_out_pubed1[["z0"]]*med_out_iged1[["d0"]]*100/med_out_pubed1[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_pubed2[["z0"]]*med_out_iged2[["d0"]]*100/med_out_pubed2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_pubed3[["z0"]]*med_out_iged3[["d0"]]*100/med_out_pubed3[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_publib1[["z0"]]*med_out_iglib1[["d0"]]*100/med_out_publib1[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_publib2[["z0"]]*med_out_iglib2[["d0"]]*100/med_out_publib2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_publib3[["z0"]]*med_out_iglib3[["d0"]]*100/med_out_publib3[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_pubing1[["z0"]]*med_out_iging1[["d0"]]*100/med_out_pubing1[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_pubing2[["z0"]]*med_out_iging2[["d0"]]*100/med_out_pubing2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_pubing3[["z0"]]*med_out_iging3[["d0"]]*100/med_out_pubing3[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_pubing4[["z0"]]*med_out_iging4[["d0"]]*100/med_out_pubing4[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_pubing5[["z0"]]*med_out_iging5[["d0"]]*100/med_out_pubing5[["tau.coef"]],1),"%")
                                             ),
                    ...
                    Porcentaje_Indirecto = c(
                                             paste0(round(med_out_prived1[["z0"]]*med_out_iged1[["d0"]]*100/med_out_prived1[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_prived2[["z0"]]*med_out_iged2[["d0"]]*100/med_out_prived2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_prived3[["z0"]]*med_out_iged3[["d0"]]*100/med_out_prived3[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_privlib1[["z0"]]*med_out_iglib1[["d0"]]*100/med_out_privlib1[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_privlib2[["z0"]]*med_out_iglib2[["d0"]]*100/med_out_privlib2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_privlib3[["z0"]]*med_out_iglib3[["d0"]]*100/med_out_privlib3[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_priving1[["z0"]]*med_out_iging1[["d0"]]*100/med_out_priving1[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_priving2[["z0"]]*med_out_iging2[["d0"]]*100/med_out_priving2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_priving3[["z0"]]*med_out_iging3[["d0"]]*100/med_out_priving3[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_priving4[["z0"]]*med_out_iging4[["d0"]]*100/med_out_priving4[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_priving5[["z0"]]*med_out_iging5[["d0"]]*100/med_out_priving5[["tau.coef"]],1),"%")
                                             )
                    )
...
collapse_rows_dt2 <- data.frame(Variable = c(rep("Educación de los padres", 3), rep("Cantidad de libros", 3), rep("Quintiles de ingreso",5)),
                    ...
                    Porcentaje_Indirecto = c(
                                             paste0(round(med_out_iged1.2[["z0"]]*med_out_iged1.2[["d0"]]*100/med_out_iged1.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iged2.2[["z0"]]*med_out_iged2.2[["d0"]]*100/med_out_iged2.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iged3.2[["z0"]]*med_out_iged3.2[["d0"]]*100/med_out_iged3.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iglib1.2[["z0"]]*med_out_iglib1.2[["d0"]]*100/med_out_iglib1.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iglib2.2[["z0"]]*med_out_iglib2.2[["d0"]]*100/med_out_iglib2.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iglib3.2[["z0"]]*med_out_iglib3.2[["d0"]]*100/med_out_iglib3.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iging1.2[["z0"]]*med_out_iging1.2[["d0"]]*100/med_out_iging1.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iging2.2[["z0"]]*med_out_iging2.2[["d0"]]*100/med_out_iging2.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iging3.2[["z0"]]*med_out_iging3.2[["d0"]]*100/med_out_iging3.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iging4.2[["z0"]]*med_out_iging4.2[["d0"]]*100/med_out_iging4.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_iging5.2[["z0"]]*med_out_iging5.2[["d0"]]*100/med_out_iging5.2[["tau.coef"]],1),"%")
                                             ),
                    ...
                    Efectos_Totales = c(paste0(round(med_out_pubed1.2[["tau.coef"]],3), gtools::stars.pval(med_out_pubed1.2[["tau.p"]])),
                     ...
                     Porcentaje_Indirecto = c(
                                             paste0(round(med_out_pubed1.2[["z0"]]*med_out_iged1.2[["d0"]]*100/med_out_pubed1.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_pubed2.2[["z0"]]*med_out_iged2.2[["d0"]]*100/med_out_pubed2.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_pubed3.2[["z0"]]*med_out_iged3.2[["d0"]]*100/med_out_pubed3.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_publib1.2[["z0"]]*med_out_iglib1.2[["d0"]]*100/med_out_publib1.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_publib2.2[["z0"]]*med_out_iglib2.2[["d0"]]*100/med_out_publib2.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_publib3.2[["z0"]]*med_out_iglib3.2[["d0"]]*100/med_out_publib3.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_pubing1.2[["z0"]]*med_out_iging1.2[["d0"]]*100/med_out_pubing1.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_pubing2.2[["z0"]]*med_out_iging2.2[["d0"]]*100/med_out_pubing2.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_pubing3.2[["z0"]]*med_out_iging3.2[["d0"]]*100/med_out_pubing3.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_pubing4.2[["z0"]]*med_out_iging4.2[["d0"]]*100/med_out_pubing4.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_pubing5.2[["z0"]]*med_out_iging5.2[["d0"]]*100/med_out_pubing5.2[["tau.coef"]],1),"%")
                                             ),
                    ...
                    Efectos_Totales = c(paste0(round(med_out_prived1.2[["tau.coef"]],3), gtools::stars.pval(med_out_prived1.2[["tau.p"]])),
                     ...
                     Porcentaje_Indirecto = c(
                                             paste0(round(med_out_prived1.2[["z0"]]*med_out_iged1.2[["d0"]]*100/med_out_prived1.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_prived2.2[["z0"]]*med_out_iged2.2[["d0"]]*100/med_out_prived2.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_prived3.2[["z0"]]*med_out_iged3.2[["d0"]]*100/med_out_prived3.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_privlib1.2[["z0"]]*med_out_iglib1.2[["d0"]]*100/med_out_privlib1.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_privlib2.2[["z0"]]*med_out_iglib2.2[["d0"]]*100/med_out_privlib2.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_privlib3.2[["z0"]]*med_out_iglib3.2[["d0"]]*100/med_out_privlib3.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_priving1.2[["z0"]]*med_out_iging1.2[["d0"]]*100/med_out_priving1.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_priving2.2[["z0"]]*med_out_iging2.2[["d0"]]*100/med_out_priving2.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_priving3.2[["z0"]]*med_out_iging3.2[["d0"]]*100/med_out_priving3.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_priving4.2[["z0"]]*med_out_iging4.2[["d0"]]*100/med_out_priving4.2[["tau.coef"]],1),"%"),
                                             paste0(round(med_out_priving5.2[["z0"]]*med_out_iging5.2[["d0"]]*100/med_out_priving5.2[["tau.coef"]],1),"%")
                                             )
                    )
