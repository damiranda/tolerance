...
```{r}
data_proc$Educacion <-as.numeric(data_proc$Educacion)
data_proc$Libros_apod_rec <-as.numeric(data_proc$Libros_apod_rec)
data_proc$quintiles_ingresos_pc_factor <- as.numeric(data_proc$quintiles_ingresos_pc_factor)

corrplot.mixed(cor(dplyr::select(data_proc, igualdad.est, esp_publico.est, esp_privado.est, Educacion, Libros_apod_rec, quintiles_ingresos_pc_factor),
                   method="spearman",
                   use = "na.or.complete"))

windowsFonts(A = windowsFont("Times New Roman"))
cormat <- cor(dplyr::select(data_proc, igualdad.est, esp_publico.est, esp_privado.est, Educacion, Libros_apod_rec, quintiles_ingresos_pc_factor),
                   method="spearman",
                   use = "na.or.complete")
...
corr.test(dplyr::select(data_proc, igualdad.est, esp_publico.est, esp_privado.est, Educacion, Libros_apod_rec, quintiles_ingresos_pc_factor),
                   method="spearman",
                   use = "complete")$p
```
...
```{r}
corrplot.mixed(cor(dplyr::select(data_proc, igualdad.est, esp_publico.est, esp_privado.est, igualdad.pad, esp_publico.pad, esp_privado.pad),
                   use = "na.or.complete"))

windowsFonts(A = windowsFont("Times New Roman"))
cormat <- cor(dplyr::select(data_proc, igualdad.est, esp_publico.est, esp_privado.est, igualdad.pad, esp_publico.pad, esp_privado.pad),
                   use = "na.or.complete")
...
corr.test(dplyr::select(data_proc, igualdad.est, esp_publico.est, esp_privado.est, igualdad.pad, esp_publico.pad, esp_privado.pad),
                   use = "complete")$p
```
...
```{r}
corrplot.mixed(cor(dplyr::select(data_proc, igualdad.pad, esp_publico.pad, esp_privado.pad, Educacion, Libros_apod_rec, quintiles_ingresos_pc_factor),
                   method="spearman",
                   use = "na.or.complete"))

windowsFonts(A = windowsFont("Times New Roman"))
cormat <- cor(dplyr::select(data_proc, igualdad.pad, esp_publico.pad, esp_privado.pad, Educacion, Libros_apod_rec, quintiles_ingresos_pc_factor),
                   method="spearman",
                   use = "na.or.complete")
...
corr.test(dplyr::select(data_proc, igualdad.pad, esp_publico.pad, esp_privado.pad, Educacion, Libros_apod_rec, quintiles_ingresos_pc_factor),
                   method="spearman",
                   use = "complete")$p
```
...
pcor(dplyr::select(data_proc, igualdad.est, Educacion, Libros_apod_rec, quintiles_ingresos_pc_factor, igualdad.pad))
```
```{r}
# Espacio publico
pcor(dplyr::select(data_proc, esp_publico.est, Educacion, Libros_apod_rec, quintiles_ingresos_pc_factor, esp_publico.pad))
```
```{r}
# Espacio privado
pcor(dplyr::select(data_proc, esp_privado.est, Educacion, Libros_apod_rec, quintiles_ingresos_pc_factor, esp_privado.pad))
```
...
```{r}
corrplot.mixed(cor(dplyr::select(data_proc, igualdad.est, esp_publico.est, esp_privado.est, ap_discusion, mean_discusion, num_fem),
                   use = "na.or.complete"))

windowsFonts(A = windowsFont("Times New Roman"))
cormat <- cor(dplyr::select(data_proc, igualdad.est, esp_publico.est, esp_privado.est, ap_discusion, mean_discusion, num_fem),
                   use = "na.or.complete")
...
corr.test(dplyr::select(data_proc, igualdad.est, esp_publico.est, esp_privado.est, ap_discusion, mean_discusion, num_fem),
                   use = "complete")$p
```
