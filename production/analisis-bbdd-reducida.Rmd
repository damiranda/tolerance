...
```{r}
data_proc <- data_proc %>%
  mutate(ed_basica = case_when(Educacion == "8vo básico o menos" ~ 1,
                               TRUE ~ 0),
         ed_media = case_when(Educacion == "Educación Media" ~ 1,
                              TRUE ~ 0),
         ed_tecni = case_when(Educacion == "Educación Téc.Superior" ~ 1,
                              TRUE ~ 0),
         ed_supe = case_when(Educacion == "Universidad o Posgrado" ~ 1,
                             TRUE ~ 0))
data_proc <- data_proc %>%
  mutate(libros1 = case_when(Libros_apod_rec == "Entre 0 y 10 libros" ~ 1,
                               TRUE ~ 0),
         libros2 = case_when(Libros_apod_rec == "Entre 11 y 25 libros" ~ 1,
                              TRUE ~ 0),
         libros3 = case_when(Libros_apod_rec == "Entre 26 y 100 libros" ~ 1,
                              TRUE ~ 0),
         libros4 = case_when(Libros_apod_rec == "Más de 100 libros" ~ 1,
                             TRUE ~ 0))

data_proc <- data_proc %>%
  mutate(quintil1 = case_when(quintiles_ingresos_pc_factor == "Quintil 1" ~ 1,
                               TRUE ~ 0),
         quintil2 = case_when(quintiles_ingresos_pc_factor == "Quintil 2" ~ 1,
                              TRUE ~ 0),
         quintil3 = case_when(quintiles_ingresos_pc_factor == "Quintil 3" ~ 1,
                              TRUE ~ 0),
         quintil4 = case_when(quintiles_ingresos_pc_factor == "Quintil 4" ~ 1,
                             TRUE ~ 0),
         quintil5 = case_when(quintiles_ingresos_pc_factor == "Quintil 5" ~ 1,
                              TRUE ~ 0),
         quintilna= case_when(quintiles_ingresos_pc_factor == "Ns/Nr" ~ 1,
                              TRUE ~ 0))


reg_med_ig1 <- lme4::lmer(igualdad.pad ~ ed_media + ed_tecni + ed_supe + libros2 + libros3 + libros4 + quintil2 + quintil3 + quintil4 + quintil5 + quintilna + REGION + dependencia + (1 | RBD), data = data_proc)

reg_out_ig1 <- lme4::lmer(igualdad.est ~ igualdad.pad + ed_media + ed_tecni + ed_supe + libros2 + libros3 + libros4 + quintil2 + quintil3 + quintil4 + quintil5 + quintilna + Sexo + ap_discusion + mean_discusion + num_fem + c_civic + REGION + dependencia + (1 | RBD), data=data_proc)
```

```{r}
med_out_iged1 <- mediate(reg_med_ig1, reg_out_ig1, treat = "ed_media", mediator = "igualdad.pad", sims = 100)
med_out_iged2 <- mediate(reg_med_ig1, reg_out_ig1, treat = "ed_tecni", mediator = "igualdad.pad", sims = 100)
med_out_iged3 <- mediate(reg_med_ig1, reg_out_ig1, treat = "ed_supe", mediator = "igualdad.pad", sims = 100)
...
```{r}
# Libros
med_out_iglib1 <- mediate(reg_med_ig1, reg_out_ig1, treat = "libros2", mediator = "igualdad.pad", sims = 100)
med_out_iglib2 <- mediate(reg_med_ig1, reg_out_ig1, treat = "libros3", mediator = "igualdad.pad", sims = 100)
med_out_iglib3 <- mediate(reg_med_ig1, reg_out_ig1, treat = "libros4", mediator = "igualdad.pad", sims = 100)
...
```{r}
# Ingresos
med_out_iging1 <- mediate(reg_med_ig1, reg_out_ig1, treat = "quintil2", mediator = "igualdad.pad", sims = 100)
med_out_iging2 <- mediate(reg_med_ig1, reg_out_ig1, treat = "quintil3", mediator = "igualdad.pad", sims = 100)
med_out_iging3 <- mediate(reg_med_ig1, reg_out_ig1, treat = "quintil4", mediator = "igualdad.pad", sims = 100)
med_out_iging4 <- mediate(reg_med_ig1, reg_out_ig1, treat = "quintil5", mediator = "igualdad.pad", sims = 100)
med_out_iging5 <- mediate(reg_med_ig1, reg_out_ig1, treat = "quintilna", mediator = "igualdad.pad", sims = 100)
...
### Espacio público
```{r}
reg_med_pub1 <- lme4::lmer(esp_publico.pad ~ ed_media + ed_tecni + ed_supe + libros2 + libros3 + libros4 + quintil2 + quintil3 + quintil4 + quintil5 + quintilna + REGION + dependencia + (1 | RBD), data = data_proc)

reg_out_pub1 <- lme4::lmer(esp_publico.est ~ esp_publico.pad + ed_media + ed_tecni + ed_supe + libros2 + libros3 + libros4 + quintil2 + quintil3 + quintil4 + quintil5 + quintilna + Sexo + ap_discusion + mean_discusion + num_fem + c_civic + REGION + dependencia + (1 | RBD), data=data_proc)
```

```{r}
# Educacion
med_out_pubed1 <- mediate(reg_med_pub1, reg_out_pub1, treat = "ed_media", mediator = "esp_publico.pad", sims = 100)
med_out_pubed2 <- mediate(reg_med_pub1, reg_out_pub1, treat = "ed_tecni", mediator = "esp_publico.pad", sims = 100)
med_out_pubed3 <- mediate(reg_med_pub1, reg_out_pub1, treat = "ed_supe", mediator = "esp_publico.pad", sims = 100)
...
```{r}
# Libros
med_out_publib1 <- mediate(reg_med_pub1, reg_out_pub1, treat = "libros2", mediator = "esp_publico.pad", sims = 100)
med_out_publib2 <- mediate(reg_med_pub1, reg_out_pub1, treat = "libros3", mediator = "esp_publico.pad", sims = 100)
med_out_publib3 <- mediate(reg_med_pub1, reg_out_pub1, treat = "libros4", mediator = "esp_publico.pad", sims = 100)
...
```{r}
# Ingresos
med_out_pubing1 <- mediate(reg_med_pub1, reg_out_pub1, treat = "quintil2", mediator = "esp_publico.pad", sims = 100)
med_out_pubing2 <- mediate(reg_med_pub1, reg_out_pub1, treat = "quintil3", mediator = "esp_publico.pad", sims = 100)
med_out_pubing3 <- mediate(reg_med_pub1, reg_out_pub1, treat = "quintil4", mediator = "esp_publico.pad", sims = 100)
med_out_pubing4 <- mediate(reg_med_pub1, reg_out_pub1, treat = "quintil5", mediator = "esp_publico.pad", sims = 100)
med_out_pubing5 <- mediate(reg_med_pub1, reg_out_pub1, treat = "quintilna", mediator = "esp_publico.pad", sims = 100)
...
### Espacio privado
```{r}
reg_med_priv1 <- lme4::lmer(esp_privado.pad ~ ed_media + ed_tecni + ed_supe + libros2 + libros3 + libros4 + quintil2 + quintil3 + quintil4 + quintil5 + quintilna + REGION + dependencia + (1 | RBD), data = data_proc)

reg_out_priv1 <- lme4::lmer(esp_privado.est ~ esp_privado.pad + ed_media + ed_tecni + ed_supe + libros2 + libros3 + libros4 + quintil2 + quintil3 + quintil4 + quintil5 + quintilna + Sexo + ap_discusion + mean_discusion + num_fem + c_civic + REGION + dependencia + (1 | RBD), data=data_proc)
```

```{r}
# Educacion
med_out_prived1 <- mediate(reg_med_priv1, reg_out_priv1, treat = "ed_media", mediator = "esp_privado.pad", sims = 100)
med_out_prived2 <- mediate(reg_med_priv1, reg_out_priv1, treat = "ed_tecni", mediator = "esp_privado.pad", sims = 100)
med_out_prived3 <- mediate(reg_med_priv1, reg_out_priv1, treat = "ed_supe", mediator = "esp_privado.pad", sims = 100)
...
```{r}
# Libros
med_out_privlib1 <- mediate(reg_med_priv1, reg_out_priv1, treat = "libros2", mediator = "esp_privado.pad", sims = 100)
med_out_privlib2 <- mediate(reg_med_priv1, reg_out_priv1, treat = "libros3", mediator = "esp_privado.pad", sims = 100)
med_out_privlib3 <- mediate(reg_med_priv1, reg_out_priv1, treat = "libros4", mediator = "esp_privado.pad", sims = 100)
...
```{r}
# Ingresos
med_out_priving1 <- mediate(reg_med_priv1, reg_out_priv1, treat = "quintil2", mediator = "esp_privado.pad", sims = 100)
med_out_priving2 <- mediate(reg_med_priv1, reg_out_priv1, treat = "quintil3", mediator = "esp_privado.pad", sims = 100)
med_out_priving3 <- mediate(reg_med_priv1, reg_out_priv1, treat = "quintil4", mediator = "esp_privado.pad", sims = 100)
med_out_priving4 <- mediate(reg_med_priv1, reg_out_priv1, treat = "quintil5", mediator = "esp_privado.pad", sims = 100)
med_out_priving5 <- mediate(reg_med_priv1, reg_out_priv1, treat = "quintilna", mediator = "esp_privado.pad", sims = 100)
...
### Igualdad de derechos y oportunidades
```{r}
reg_med_ig2 <- lme4::lmer(igualdad.pad ~ ed_media + ed_tecni + ed_supe + libros2 + libros3 + libros4 + quintil2 + quintil3 + quintil4 + quintil5 + quintilna + Sexo + ap_discusion + mean_discusion + num_fem + c_civic  + REGION + dependencia + (1 | RBD), data = data_proc)

reg_out_ig2 <- lme4::lmer(igualdad.est ~ igualdad.pad + ed_media + ed_tecni + ed_supe + libros2 + libros3 + libros4 + quintil2 + quintil3 + quintil4 + quintil5 + quintilna + Sexo + ap_discusion + mean_discusion + num_fem + c_civic + REGION + dependencia + (1 | RBD), data=data_proc)
```

```{r}
# Educacion
med_out_iged1.2 <- mediate(reg_med_ig2, reg_out_ig2, treat = "ed_media", mediator = "igualdad.pad", sims = 100)
med_out_iged2.2 <- mediate(reg_med_ig2, reg_out_ig2, treat = "ed_tecni", mediator = "igualdad.pad", sims = 100)
med_out_iged3.2 <- mediate(reg_med_ig2, reg_out_ig2, treat = "ed_supe", mediator = "igualdad.pad", sims = 100)
...
```{r}
# Libros
med_out_iglib1.2 <- mediate(reg_med_ig2, reg_out_ig2, treat = "libros2", mediator = "igualdad.pad", sims = 100)
med_out_iglib2.2 <- mediate(reg_med_ig2, reg_out_ig2, treat = "libros3", mediator = "igualdad.pad", sims = 100)
med_out_iglib3.2 <- mediate(reg_med_ig2, reg_out_ig2, treat = "libros4", mediator = "igualdad.pad", sims = 100)
...
```{r}
# Ingresos
med_out_iging1.2 <- mediate(reg_med_ig2, reg_out_ig2, treat = "quintil2", mediator = "igualdad.pad", sims = 100)
med_out_iging2.2 <- mediate(reg_med_ig2, reg_out_ig2, treat = "quintil3", mediator = "igualdad.pad", sims = 100)
med_out_iging3.2 <- mediate(reg_med_ig2, reg_out_ig2, treat = "quintil4", mediator = "igualdad.pad", sims = 100)
med_out_iging4.2 <- mediate(reg_med_ig2, reg_out_ig2, treat = "quintil5", mediator = "igualdad.pad", sims = 100)
med_out_iging5.2 <- mediate(reg_med_ig2, reg_out_ig2, treat = "quintilna", mediator = "igualdad.pad", sims = 100)
...
### Espacio público
```{r}
reg_med_pub2 <- lme4::lmer(esp_publico.pad ~ ed_media + ed_tecni + ed_supe + libros2 + libros3 + libros4 + quintil2 + quintil3 + quintil4 + quintil5 + quintilna + Sexo + ap_discusion + mean_discusion + num_fem + c_civic + REGION + dependencia + (1 | RBD), data = data_proc)

reg_out_pub2 <- lme4::lmer(esp_publico.est ~ esp_publico.pad + ed_media + ed_tecni + ed_supe + libros2 + libros3 + libros4 + quintil2 + quintil3 + quintil4 + quintil5 + quintilna + Sexo + ap_discusion + mean_discusion + num_fem + c_civic + REGION + dependencia + (1 | RBD), data=data_proc)
```

```{r}
# Educacion
med_out_pubed1.2 <- mediate(reg_med_pub2, reg_out_pub2, treat = "ed_media", mediator = "esp_publico.pad", sims = 100)
med_out_pubed2.2 <- mediate(reg_med_pub2, reg_out_pub2, treat = "ed_tecni", mediator = "esp_publico.pad", sims = 100)
med_out_pubed3.2 <- mediate(reg_med_pub2, reg_out_pub2, treat = "ed_supe", mediator = "esp_publico.pad", sims = 100)
...
```{r}
# Libros
med_out_publib1.2 <- mediate(reg_med_pub2, reg_out_pub2, treat = "libros2", mediator = "esp_publico.pad", sims = 100)
med_out_publib2.2 <- mediate(reg_med_pub2, reg_out_pub2, treat = "libros3", mediator = "esp_publico.pad", sims = 100)
med_out_publib3.2 <- mediate(reg_med_pub2, reg_out_pub2, treat = "libros4", mediator = "esp_publico.pad", sims = 100)
...
```{r}
# Ingresos
med_out_pubing1.2 <- mediate(reg_med_pub2, reg_out_pub2, treat = "quintil2", mediator = "esp_publico.pad", sims = 100)
med_out_pubing2.2 <- mediate(reg_med_pub2, reg_out_pub2, treat = "quintil3", mediator = "esp_publico.pad", sims = 100)
med_out_pubing3.2 <- mediate(reg_med_pub2, reg_out_pub2, treat = "quintil4", mediator = "esp_publico.pad", sims = 100)
med_out_pubing4.2 <- mediate(reg_med_pub2, reg_out_pub2, treat = "quintil5", mediator = "esp_publico.pad", sims = 100)
med_out_pubing5.2 <- mediate(reg_med_pub2, reg_out_pub2, treat = "quintilna", mediator = "esp_publico.pad", sims = 100)
...
### Espacio privado
```{r}
reg_med_priv2 <- lme4::lmer(esp_privado.pad ~ ed_media + ed_tecni + ed_supe + libros2 + libros3 + libros4 + quintil2 + quintil3 + quintil4 + quintil5 + quintilna + Sexo + ap_discusion + mean_discusion + num_fem + c_civic + REGION + dependencia + (1 | RBD), data = data_proc)

reg_out_priv2 <- lme4::lmer(esp_privado.est ~ esp_privado.pad + ed_media + ed_tecni + ed_supe + libros2 + libros3 + libros4 + quintil2 + quintil3 + quintil4 + quintil5 + quintilna + Sexo + ap_discusion + mean_discusion + num_fem + c_civic + REGION + dependencia + (1 | RBD), data=data_proc)
```

```{r}
# Educacion
med_out_prived1.2 <- mediate(reg_med_priv2, reg_out_priv2, treat = "ed_media", mediator = "esp_privado.pad", sims = 100)
med_out_prived2.2 <- mediate(reg_med_priv2, reg_out_priv2, treat = "ed_tecni", mediator = "esp_privado.pad", sims = 100)
med_out_prived3.2 <- mediate(reg_med_priv2, reg_out_priv2, treat = "ed_supe", mediator = "esp_privado.pad", sims = 100)
...
```{r}
# Libros
med_out_privlib1.2 <- mediate(reg_med_priv2, reg_out_priv2, treat = "libros2", mediator = "esp_privado.pad", sims = 100)
med_out_privlib2.2 <- mediate(reg_med_priv2, reg_out_priv2, treat = "libros3", mediator = "esp_privado.pad", sims = 100)
med_out_privlib3.2 <- mediate(reg_med_priv2, reg_out_priv2, treat = "libros4", mediator = "esp_privado.pad", sims = 100)
...
```{r}
# Ingresos
med_out_priving1.2 <- mediate(reg_med_priv2, reg_out_priv2, treat = "quintil2", mediator = "esp_privado.pad", sims = 100)
med_out_priving2.2 <- mediate(reg_med_priv2, reg_out_priv2, treat = "quintil3", mediator = "esp_privado.pad", sims = 100)
med_out_priving3.2 <- mediate(reg_med_priv2, reg_out_priv2, treat = "quintil4", mediator = "esp_privado.pad", sims = 100)
med_out_priving4.2 <- mediate(reg_med_priv2, reg_out_priv2, treat = "quintil5", mediator = "esp_privado.pad", sims = 100)
med_out_priving5.2 <- mediate(reg_med_priv2, reg_out_priv2, treat = "quintilna", mediator = "esp_privado.pad", sims = 100)
