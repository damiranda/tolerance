...
pcor(dplyr::select(data_proc, igualdad.est, Educacion, Libros_apod_rec, quintiles_ingresos_pc_factor, igualdad.pad))$estimate
```
```{r}
# Espacio publico
pcor(dplyr::select(data_proc, esp_publico.est, Educacion, Libros_apod_rec, quintiles_ingresos_pc_factor, esp_publico.pad))$estimate
```
```{r}
# Espacio privado
pcor(dplyr::select(data_proc, esp_privado.est, Educacion, Libros_apod_rec, quintiles_ingresos_pc_factor, esp_privado.pad))$estimate
```
