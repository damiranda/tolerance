...
- Anaís Herrera^[Universidad de Chile]
- Kevin Carrasco$^{***}$
output:
  pdf_document:
    toc: no
...
## *Métodos*
Las hipótesis y el plan de análisis de esta investigación fueron pre registrados en Open Science Framework del Centro de Ciencia Abierta (OSF, Center for Open Science). Luego, el análisis estadístico de esta investigación fue realizado mediante el software libre R versión 4.0.0.
...
df<- dfSummary(select(descr,igualdad.est:quintiles_ingresos_pc_factor),
               plain.ascii = FALSE,
               style = "grid",
               tmp.img.dir = "/tmp",
               graph.magnif = 0.75,
...
kable(data.frame(image='![](output/desc01.png){width="500"}'),    # generar tabla
             caption="Descripción de las variables utilizadas en los análisis (parte 1)",
             col.names = "",
             row.names = F,
...
kable(data.frame(image='![](output/desc02.png){width="550"}'), # generar tabla
             caption="Descripción de las variables utilizadas en los análisis (parte 2)",
             col.names = "",
             row.names = F,
             format = "pipe") %>%  kable_styling(latex_options = c("HOLD_position"),full_width = T)
```
...
```{r echo=FALSE, fig.cap="Actitudes de los estudiantes hacia la igualdad de género según los recursos socioeconómicos de la familia.", fig.align = 'center', out.width = '80%',out.height='80%'}
knitr::include_graphics(path = "output/general.png")
```
...
```{r echo=FALSE, fig.cap="Actitudes de los estudiantes hacia la igualdad de género según el sexo del estudiante.", fig.align = 'center', out.width = '80%',out.height='80%'}
...
```{r echo=FALSE, fig.cap="Actitudes de los estudiantes hacia la igualdad de género según las actitudes de su apoderado.", fig.align = 'center', out.width = '80%',out.height='80%'}
knitr::include_graphics(path = "output/general_h3.png")
```

```{r echo=FALSE, fig.cap="Actitudes de los estudiantes hacia la igualdad de género según las características de la escuela.", fig.align = 'center', out.width = '80%',out.height='80%'}
