...
bibliography: 
  - "input/bib/Tolerancia.bib"
csl: "input/bib/apa6.csl"
linkcolor: blue
abstract: "La socialización política de actitudes hacia la igualdad de género es un elemento clave para la construcción de sociedades más democráticas y tolerantes, entendiendo la igualdad de derechos entre hombres y mujeres como un principio básico de toda democracia. Utilizando datos del Panel de Ciudadanía Escolar 2019 (Ola 1) se analizan las actitudes de 627 estudiantes de 2° medio y sus apoderados, pertenecientes a 60 escuelas de tres regiones de Chile. Se provee evidencia acerca del rol que juegan los recursos socioeconómicos de la familia sobre las actitudes hacia la igualdad de género de estudiantes y apoderados. Asimismo, se provee evidencia acerca del grado de consistencia de la transmisión intergeneracional de actitudes entre estudiantes y apoderados. Finalmente, se muestra la influencia sobre las actitudes de los jóvenes de dos características de la escuela, el porcentaje de niñas y la percepción de apertura a la discusión en el aula." 
---
